...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ArrayList<Integer> args = fragmentArguments.getIntegerArrayList(MainActivity.TAG_FRIEND_RES_IDS);
		Integer[] arguments = new Integer[args.size()];
		for (int i = 0; i < arguments.length; i++) {
			arguments[i] = args.get(i);
		}

		// TODO: Start the DownloaderTask 
		downloader.execute(arguments);
	}
	...
	public class DownloaderTask extends AsyncTask<Integer, Void, String[]> {
		...
		protected String[] doInBackground(Integer... arg0) {
			...
			Integer[] resource = new Integer[arg0.length];
			for(int i = 0; i < arg0.length; i++) {
				resource[i] = arg0[i];
			}
			String[] result = downloadTweets(resource);
			return result;
		}
